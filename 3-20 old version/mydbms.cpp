...
using namespace std;
    ...
    User mydbms::queryData(string tableName, string userName, string passWord){
        ...
        auto lambda_callback = [](void* data, int argc, char** argv, char** colName) -> int {
            vector<User>* users = (vector<User>*)data;
             User u;
            if (argc >= 7) {
     ...
     bool mydbms::updataeData(string tableName, string userName, string passWord, string colname, auto value){
