...
public:
    Bank(const string& name, const string& dbname);
    ...
    vector<shared_ptr<Account>> getAllAccounts(const string& tableName) const;
    ...
    // Query operations
    double getAccountBalance(const string& tableName, const string& userName, const string& passWord) const;
    void displayAllAccounts(const string& tableName) const;
    void displayTransactionHistory() const;
    
    // Statistics
    int getTotalAccounts(const string& tableName) const;
    double getTotalBankBalance(const string& tableName) const;
